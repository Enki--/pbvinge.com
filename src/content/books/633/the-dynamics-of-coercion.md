...
cover: "http://books.google.com/books/content?id=L_0ImO7Y1d8C&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"
status: "Complete"
created: 2025-12-08 19:10:25
updated: 2025-12-08 19:10:25
class: "633"
sequence: "4"
---
...
- Coercion is about _changing choices_, not simply destroying capability.
    
- Success is probabilistic and incremental—authors emphasize changes in likelihood of behavior, not a binary yes/no outcome.
    
- Coercion is a _dynamic contest_: both sides adapt cost–benefit calculations over time.
...
Used mainly to clarify scope: study concentrates on _coercive diplomacy_ (largely compellence), while acknowledging many cases have intertwined deterrent and compellent phases.
...
Coercive strategy aimed at making the adversary _change_ current policy, behavior, or posture.
...
- Air campaigns are typically _compellent_ in practice, even when labeled “deterrent.”
...
- Important to distinguish: _denial coercion_ may resemble brute force but aims at perceptions of futility, not simply military collapse.
...
Umbrella concept for the study. Air power is treated as an _instrument_ within broader coercive diplomacy, not a stand‑alone solution.
...
- Success is conceptualized as _marginal change_ in the probability of desired behavior.
...
- Dominance is _relative_, not absolute; most adversaries retain some low‑tech escalation options.
...
- Related but not identical to brute force; focus is on _perceptions_ that victory is impossible, not necessarily destroying all forces.
...
- Explicitly engages Pape’s _Bombing to Win_: accepts his emphasis on denial but treats it as _one_ of several viable strategies and embeds it in a broader context.
...
Third core success factor. Many successes rely on making adversary fear _others_ more: Croat/Muslim forces in Bosnia, Kurds backed by Iran in Iraq.
...
One of three recurrent _challenges_ undermining coercion (along with credibility and feasibility).
...
Coercing an adversary _through_ pressure on third parties—clients, sponsors, or local rivals—rather than directly.
...
- Emphasis on _time_ and sequencing: outcomes can change as costs accumulate.
...
Clarifies that brute force seeks to disarm regardless of the enemy’s choices, while coercion aims to influence choices by exploiting the _threat_ of future harm.
...
- Coercion: “If you do X, we _will_ hurt you more.”
...
_(Approximate; focus on coercive airpower episodes emphasized in the book)_
...
- Engages **Pape** by adopting his denial concept but rejecting the idea that denial is the _only_ effective air strategy; instead, denial is one pillar among three.
...
7. Does Byman et al.’s framework imply that certain crisis types should _never_ rely on coercive airpower as the main tool?
...
2. **“Denial and Beyond: Revisiting Pape”** – Use the 3+3 framework to reassess Pape’s _Bombing to Win_ cases; argue for or against his denial‑only thesis.
